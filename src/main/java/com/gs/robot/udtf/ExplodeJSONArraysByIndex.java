...
public class ExplodeJSONArraysByIndex extends TableFunction<String []> {
    private static final ObjectMapper objectMapper = new ObjectMapper();
    private static final Logger logger = LoggerFactory.getLogger(ExplodeJSONArraysByIndex.class);
